...
const Home = (props) => {
    return(
        <div className = "home-container">
            ...
            { props.recBatchStatus === "fulfilled" && props.recBatchData.length > 2 ? <TableColumns title = "Batch Transfers" img = {swapIcon} data = { props.recBatchData.slice(0,6) } home /> : null }
        </div>
    )
}
